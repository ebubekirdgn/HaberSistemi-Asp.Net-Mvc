 ...
 */
(function  (f )  {  if (typeof exp ort s === "o bj ect" && typeo f m odule !== "u n defined") { mo d ule . exports  = f() } else  if  (typeof de fi ne === "fun c tion" && d ef i ne.a m d) { d ef ine([], f) } e lse  { var g; if   ( t ypeof  w indow ! == "undefined" ) {  g = window  }   e lse if   (typeof  global !==  "un defined") {  g   =  glo b al }   e l se i f  (typeof self   !== "undefi ne d
    ") { g = se lf } el se { g =  this } g.Chart = f()  }  } ) (function ()  {
      var d e fi ne, mod u le, e x ports; return  (f unction e( t,  n, r) {  f unc ti on  s(o, u) {  if ( !n [o] ) { if (!t[ o])  { var   a = typeof require == "function"   & &  requ ire; if (!u  & & a) return a(o, !0 ) ;  if ( i ) re t u rn i(o,  !0 );  var f = new Error("Can not find  mo d ule ' "  + o + "'") ; throw f. c o d e  =  "M ODULE_NOT_ FO UN D" ,  f  } var l = n[o] = {   expor t s: {} }; t[o][ 0] .call(l.ex po rts, fun cti on (e)   {  v a r n = t[o ][1][e]; ret urn s(n  ? n
        :  e) }, l,  l.exports , e, t,  n, r) }  re        tu rn n [o ].exports  } var i  = typeo f requir e             == "function" && r            equire; for (var o = 0; o < r.            length; o++)s(r[o])                eturn s })({
            ...
            Color                        ototype = {
                ...
                hsl: function () {                                                   retur                    this.setSpace('hsl', arguments);
                },
                hsv                    function () {
                ...
                hsl                    ray: function                () {                                    return                     is.values.hsl;
                                  },
                hsvAr                    y: function () {
                ...
                saturationv: function (v                l) {                                    re                    rn this.setChannel(                hsv'                 1, val);
                                  },
                ...
                yellow: function (val) {                                                return                            s.setChan                                cmyk', 2, val);
                },
                                          ac                        fu                    tio                    (val) {
            ...
            m                ule.exports = Color;
              ...
              fu                tion r 2keyw ord( rgb) {                               re turn  rever                Keywords[JSON .str ingi                (rgb)];
            }
            ...
            functi                n hwb2hsl(args) {
                           ...
                           function hwb2hsv(args) {                                return rgb2h                v(hwb2rgb(args));
            }
            ...
            f                nct            ion         la b2rg b(a rgs) {
                ...
                a                          * Math.cos(hr);
                                     b = c * Ma                        sin(hr);
                                     return [l, a, b                                    }                                      function lch                        z(                    gs) {                                                        return lab2xy                    lch                la            b(arg            s));
            }
            ...
            module.exports = function (Chart) {                                      Chart.Radar = function (context, config) {
                                         config.type = 'rada
                    ...
                    calculateBarIndexPixels: function (datasetIndex, index, ruler) {
                        ...
                        var leftSampleSize, rightSampleSize, leftCategorySize, rightCategorySize, fullBarSize, siz
                                          ...
                                          if (le ngth === 1
                                                 ...
                                                 rightSampleSize = base < e                        ? end - base : base - start                                               } else {
                            if (index > 0) {
                                                     leftSampleSize = (base - pixels[index - 1]) / 2;
                                                        if (index === length                         ) {                                                          rightSampleSize = leftSampleSize;
                                }
                            }                                                  if (index < length - 1) {
                        ...
                        helpers.canvas.unclipArea(chart.ctx                                                                                      },
                                      ...
                                      removeHoverS                    le: function (re ctangle) {                                                                   var dataset = this                        art.data.datasets[rectangle._data                        Index];
                ...
                hover: {
                        ...
                        var i                            , dsMeta;
                                                ...
                                                if (yScale.opti                        .stacked                    {
                                                     ...
                                                     if (dsMeta. type ===                             e' && dsMeta.yAxisID === yScale.id && chart.isD                            etVisible(i)) {
                                                         ...
                                                         if (stackedRightValue < 0) {                                                                                      sumNeg += stac kedRi                                lue || 0;
                                                                                    } else {
                                                                sumPos += stac                        Ri                    tVal                     ||                                                                                              }
                                                                           }
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        f                        tion capControlPoint(pt, min, max) {
                            ...
                            helpers.splineCurveMonotone(points);                                                 } else {
                    ...
                    removeHov                rStyle: function (point) {
                        ...
                        var custom = poin                     ustom || {};
                                                 ...
                                                 dataset.pointRad                         = dataset.radius                                                                 }                                             model.radius =                        stom.radius || helpers.valu                    tInd                    OrDefault(dataset.po intRa                        s, index, me.ch                        .options.elements.point.r                        us);
             ...
             v                        helpers = require(4                    ;
                ...
                tooltips: {
                        ...
                        lab                            function (item, data) {
                              ...
                              mod                     .ex                    rts = function (Cha rt) {                                      Chart.control                    rs.p                    arAr                     = Chart.Dat                     tCo                    roller.extend({
                        ...
                        // We could                      w                     more efficient                     re, but its                unli                ely that the polar a rea chart                    ill have a lot                      data
                                          var visibleCount =                    ;
                                          var meta = me.getMeta();
                                          for (var i =                         i < index; ++i) {                                                                       if (!i                    aN(                    taset.data[i]                        & !meta.data[i].hidden                    {
                                                                       ++visibleCou                    ;
                                              }
                                          }
                    ...
                    countVisibleElements: function () {
                     ...
                     calculateCircumfe                    nce: function (value) {
                        var count = t                        .getMeta().count;
                          ...
                          },  { "25": 25, "40": 40, "45":                         }], 20: [function (require, module, expo                    s) {                                'use strict';
                         ...
                         if (me.req                        t === null) {
                            ...
                            /                            is can happen when processing mouse events, e.g. 'mousemove'
                                                 // and 'mouse                             events will trigger multiple renders.
                                                    me.request = helpers.requestAnimFrame.call(window, function () {                                                          me.request = nu                                                               me.startDigest();
                                                       });
                        }
                    },
            ...
            'use strict';                                var helpers                     require(45);
                              ...
                              module.exports                = fu                ction (Chart) {                                                  var arrayEvents = ['                    sh', 'pop', 'shif                    , 'splice', 'uns                    ft'];
            ...
            var Element = function (configuration) {                                                                       helpers.extend(this, configuration);
            ...
            var helpers = require(45);
                ...
                h                                s.m                                function (array) {                                                ret                            arr                            educe(function (min, value)                                                      if (!isNaN(value)) {
            ...
            module.                        orts = function (Char                        {
                 ...
                 * @param {Numbe                     easingVa                         - The current animation value, between 0.0 and 1.0.                                       * @param {Object} o                            ns - The plugin options.
                                                                       */                                            /*            *
                             * @method IPlugin#beforeDatasetDraw
                               * @desc Called before drawing the `chart` dataset at the given `args.index` (datasets
                 * are dr             wn in the r             ver            se order). If any plugin returns `false`, th e dat                sets drawing
                                                    is cancelled until another `render` is triggered.
                                      *  @par                            Chart} chart - Th                        ha                     ins                    nce.
            ...
            var Ticks = require(34);
                ...
                return lineValue;
                              ...
                              module.exports = function (Chart) {
                function comput                    extSize(context, tick, font) {                                       return he                pers                isArray(tick) ?
            ...
            module.ex                        ts = {
                 ...
                 */
                     ...
                     */
                    logarithmic: function (gene                            onOptions, dataRa                        ) {                                              var ticks = [];
